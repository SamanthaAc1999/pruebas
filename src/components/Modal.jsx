  ...
  return (
    <div style={styles.overlay} onClick={onClose}>
      <div style={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <svg width="24" height="24" style={styles.closeButton} viewBox="0 0 24 24" fill="none" onClick={onClose} xmlns="http://www.w3.org/2000/svg">
        ...
        <h2 className="text-[#151635]" style={styles.title}>{title}</h2>
